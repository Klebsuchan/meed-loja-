...
<html lang="pt-BR">
  <head>
    ...
    <meta property="og:image" content="https://meedloja.com.br/logomeed.png" />
    ...
    <meta name="twitter:image" content="https://meedloja.com.br/logomeed.png" />

    <!-- Favicons Multi-Dispositivos (PWA, Apple, Android) -->
    <link rel="icon" type="image/png" sizes="32x32" href="/logomeed.png" />
    <link rel="icon" type="image/png" sizes="16x16" href="/logomeed.png" />
    <link rel="apple-touch-icon" sizes="180x180" href="/logomeed.png" />
    <link rel="shortcut icon" href="/logomeed.png" />
    ...
    <script type="application/ld+json">
    {
      ...
      "image": "https://meedloja.com.br/logomeed.png",
